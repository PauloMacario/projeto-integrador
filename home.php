...
?>
		<a href="#" target="_blank" class=""> <!-- fh5co-site-name -->
				...
				<div class="row row-bottom-padded-md">
					<div class="col-lg-4 col-md-12 col-sm-12 text-center animate-box">
						<div class="projeto-img">	
							<p><img src="images/cover_children_1.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive img-large"></p>
						</div>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 text-center animate-box">
						<div class="projeto-img">	
							<p><img src="images/cover_animals_2.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive img-large"></p>
						</div>
						<div class="projeto-text">
					...
					<div class="col-lg-4 col-md-12 col-sm-12 text-center animate-box">
						<div class="projeto-img">
							<p><img src="images/cover_meio_3.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive img-large"></p>
						</div>
						<div class="projeto-text">
							<h3>Meio Ambiente</h3>
						...
						<form>
								<div class="form-row">
									<div class="form-group col-md-10">
										...
										<input type="email" class="form-control" id="inputEmail4" placeholder="Localizar região...">
									</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 col-md-12 text-center animate-box">
						<a href="#" class="btn btn-success btn-lg">Mais Notícias</a>
					</div>
				</div>
