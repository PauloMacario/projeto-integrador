			...
			<div class="container">
				...
				<div class="row row-bottom-padded-md">
					<div class="col-lg-4 col-md-12 col-sm-12 text-center animate-box">
						...
						<p><a href="#" ><img src="images/cover_children_1.jpg" alt="Criança e Adolescente" title="Criança e Adolescente"class="img-responsive img-large img-projeto"></a></p>
						</div>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 text-center animate-box">
						<div class="projeto-img">	
							<p><a href="#" ><img src="images/cover_animals_2.jpg" alt="Proteção aos Animais" title="Proteção aos Animais" class="img-responsive img-large img-projeto"></a></p>
						</div>
						<div class="projeto-text">
					...
					<div class="col-lg-4 col-md-12 col-sm-12 text-center animate-box">
						<div class="projeto-img">
							<p><a href="#" ><img src="images/cover_meio_3.jpg" alt="Meio Ambiente" title="Meio Ambiente" class="img-responsive img-large img-projeto"></a></p>
						</div>
						<div class="projeto-text">
							<h3>Meio Ambiente</h3>
							<div class="projeto-paragrafo">
